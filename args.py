...
def get_args():
    ...
    parser.add_argument("--blip_gpu_id", type=int, default=1,
                        help="""gpu id for BLIP model,
                                -1: same as sim gpu, -2: cpu""")
    ...
    parser.add_argument('-el', '--max_episode_length', type=int, default=532,
    ...
    parser.add_argument('--collision_queue_size', type=int, default=3)
    parser.add_argument('--wtec', type=float, default=0.5)
    parser.add_argument('--num_attrs', type=float, default=5)
